...
void washing_program_display(unsigned char key) {
    ...
    clcd_print("Washing Program", (0x80 + 1));
    clcd_print("*", (0xC0 + 0));
    if (program_no <= 9) {
...
void water_level_screen(unsigned char key) {
    ...
    clcd_print(water_level[(level + 1) % 5], (0x90 + 1));
    clcd_print(water_level[(level + 2) % 5], (0xD0 + 1));
...
void start_screen(unsigned char key) {
    ...
    reset_flag = 0x55;
    operational_mode = 0x05;
# 194 "washing_machine.c"
}
...
door_check();
    ...
    clcd_putch(sec / 10 + '0', (0xC0 + 9));
    clcd_putch(sec % 10 + '0', (0xC0 + 10));
    clcd_print("S5:START", (0x90 + 0));
    clcd_print(" S6:PAUSE", (0xD0 + 0));
    if (min == 0 && sec == 0) {
        clear_screen();
        RC2 = 0;
        RC1 = 1;
...
void door_check(){
    if (RB0 == 0){
        ...
        RC1=1;
        clear_screen();
        clcd_print("door is ",(0x80 + 0));
        clcd_print("OPENED ",(0xC0 + 0));
